...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class PrEachKeyComponent  : public PrBaseComponent,
                            public Slider::Listener
{
public:
    //==============================================================================
    PrEachKeyComponent (Settings& settings, PianoController& pianoController);
    ~PrEachKeyComponent() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PrEachKeyComponent)
};

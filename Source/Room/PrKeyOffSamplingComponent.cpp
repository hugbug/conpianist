...
//==============================================================================
PrKeyOffSamplingComponent::PrKeyOffSamplingComponent (Settings& settings, PianoController& pianoController)
...
PrKeyOffSamplingComponent::~PrKeyOffSamplingComponent()
{
...
//==============================================================================
void PrKeyOffSamplingComponent::paint (Graphics& g)
{
...
void PrKeyOffSamplingComponent::resized()
{
...
void PrKeyOffSamplingComponent::sliderValueChanged (Slider* sliderThatWasMoved)
{
...
<JUCER_COMPONENT documentType="Component" className="PrKeyOffSamplingComponent"
  ...
  <LABEL name="" id="dc20d157ffc118c5" memberName="titleLabel" virtualName=""
         ...
         edBkgCol="0" labelText="Key Off Sampling" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"

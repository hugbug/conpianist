...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class PrDamperResonanceComponent  : public PrBaseComponent,
                                    public Slider::Listener
{
public:
    //==============================================================================
    PrDamperResonanceComponent (Settings& settings, PianoController& pianoController);
    ~PrDamperResonanceComponent() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PrDamperResonanceComponent)
};

...
//==============================================================================
PrStringResonanceComponent::PrStringResonanceComponent (Settings& settings, PianoController& pianoController)
...
PrStringResonanceComponent::~PrStringResonanceComponent()
{
...
//==============================================================================
void PrStringResonanceComponent::paint (Graphics& g)
{
...
void PrStringResonanceComponent::resized()
{
...
void PrStringResonanceComponent::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    if (sliderThatWasMoved == slider.get())
    {
        ...
        inSliderChange++;
        pianoController.SetStringResonance(slider->getValue());
...
void PrStringResonanceComponent::updatePianoState(PianoController::Aspect aspect)
{
	if (aspect == PianoController::apStringResonance && inSliderChange && inSliderChange--) return;
	...
	slider->setValue(pianoController.GetStringResonance(), NotificationType::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="PrStringResonanceComponent"
  ...
  <LABEL name="" id="dc20d157ffc118c5" memberName="titleLabel" virtualName=""
         ...
         edBkgCol="0" labelText="String Resonance" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
